  ...
  describe "render_search_to_s_*" do
    ...
    describe "render_search_to_s_filters" do
      ...
      it "renders a constraint for a selected facet not in the config" do
        ...
        expect(response).to eq("<span class=\"constraint\"><span class=\"filter-name\">Undefined Facet:</span><span class=\"filter-values\"><span class=\"filter-value\">value1</span><span class=\"filter-separator\"> and </span><span class=\"filter-value\">value2</span></span></span>")
      end
